package com.qtimes.pavilion.app;
...
import com.qtimes.service.DaemonEnv;
...
import com.qtimes.pavilion.dagger.component.DaggerApplicationComponent;
import com.qtimes.pavilion.dagger.modules.ApplicationModule;
import com.qtimes.pavilion.delegate.AppDelegateManager;
...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        //双进程保活
        DaemonEnv.initialize(this, PavilionService.class, 30 * 1000);
        DaemonEnv.startServiceMayBind(PavilionService.class, null);
