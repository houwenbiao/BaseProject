package com.qtimes.wonly.update;
...
public class FileDownloadManager {
     ...
     * @return download id
     */
    public long startDownload(String url, String title, String description, String appName) {
        DownloadManager.Request req = new DownloadManager.Request(Uri.parse(url));
        req.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI);
        PluLog.i("appName：" + appName);
        req.setTitle(context.getString(R.string.apk_name));
        req.setDescription(context.getString(R.string.apk_downloading));
        req.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        //设置文件的保存的位置[三种方式]
        //第一种
        //file:///storage/emulated/0/Android/data/your-package/files/Download/update.apk
        PluLog.i("getExternalStorageState:" + Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED));
