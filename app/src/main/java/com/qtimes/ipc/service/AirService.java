...
public class AirService extends AbsWorkService {

    //keep alive
    private static final String CHANNEL_ID = "com.qtimes.wonly.notification.channel";
    public static final String MAIN_ACTIVITY_CLASS_NAME = "com.qtimes.wonly.activity.MainActivity";
    private static final int NOTIFICATION_ID = 10;
    private static final String NOTIFICATION_TITLE = "王力防夹";
    private static final String NOTIFICATION_CONTENT = "保持防夹功能开启，请勿关闭！";
    ...
    public Boolean isWorkRunning(Intent intent, int flags, int startId) {
        boolean isRunning = ActivityMgr.isActivityRunning(this, "com.qtimes.wonly.activity.MainActivity");
        if (!isRunning) {
