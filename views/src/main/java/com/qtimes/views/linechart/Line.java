...
public class Line {
    ...
    private void init(Context context) {
        ...
        if(mDefaultPaint==null){
            ...
            mDefaultPaint.setColor(0xFF6B00);
            mDefaultPaint.setStyle(Style.STROKE);
            mDefaultPaint.setAntiAlias(true);
            mDefaultPaint.setStrokeWidth(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, context.getResources()
                    .getDisplayMetrics()));
    ...
    private void buildPath() {
        ...
        mDefaultPath.lineTo(mPoints.get(mPoints.size() - 1).getX(), 0);
        mDefaultPath.lineTo(mPoints.get(0).getX(), 0);
    }
