package com.qtimes.views.blur;

/**
 * Created by liutao on 2016/12/1.
 */
...
public class BlurLayout extends FrameLayout {
    ...
    public void initActivityView(Activity activity) {
        ...
        if (mActivityView == null || mActivityView.get() == null) {
            mActivityView = new WeakReference<>(activity.getWindow().getDecorView().findViewById(android.R.id.content));
        }
    }
