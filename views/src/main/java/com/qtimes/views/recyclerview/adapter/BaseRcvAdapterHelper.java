...
public class BaseRcvAdapterHelper extends RecyclerView.ViewHolder {
    ...
    //如果有重名的view，可通过此方法查找
    @SuppressWarnings("unchecked")
    protected <T extends View> T retrieveView(int viewId, View itemView) {
        View view = views.get(viewId+itemView.hashCode());
        if (view == null) {
            view = itemView.findViewById(viewId);
            views.put(viewId+itemView.hashCode(), view);
        }
        return (T) view;
    }
    ...
    public <T extends View> T getView(int viewId, View itemView) {
        return retrieveView(viewId,itemView);
    }
    /**
    ...
    public BaseRcvAdapterHelper setText(int viewId, View itemView, String value) {
        TextView view = retrieveView(viewId,itemView);
        view.setText(value);
        return this;
    }
    public BaseRcvAdapterHelper setText(int viewId, Spanned value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
    public BaseRcvAdapterHelper setText(int viewId, View itemView, Spanned value) {
        TextView view = retrieveView(viewId,itemView);
        view.setText(value);
        return this;
    }
